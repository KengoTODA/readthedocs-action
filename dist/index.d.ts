...
export declare function run(getInput: (name: string, options?: core.InputOptions) => string, checkUpdatedDocument: (githubToken: string) => Promise<boolean>, activateProject: (translates: IProject[], rtd: RTD, branch: string, githubToken: string, project: string) => Promise<void>, deactivateProject: (translates: IProject[], rtd: RTD, branch: string, githubToken: string, project: string) => Promise<void>): Promise<void>;
